...
export default  function Footer() {
    ...
    <footer>
      <main>
        ...
        <div style={{backgroundColor:'#04060f', borderTop:'10px solid black', marginBlock:'50px', paddingBlock:'20px',paddingInline:'' display:'flex', justifyContent:'space-between'}}>
