    ...
    <footer>
      <main>
        {/* <div className='foot-head'>
          ...
          <hr style={{backgroundColor:'white', height:'5px', maxWidth:'800px', marginInline:'auto'}}/>
        <div style={{backgroundColor:'#04060f', borderTop:'10px solid black', marginBlock:'50px', paddingBlock:'20px',paddingInline:'20px' display:'flex', justifyContent:'space-between'}}>
