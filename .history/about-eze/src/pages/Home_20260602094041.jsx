...
// Skiil Section JS
  ...
  const backendSkills = [
      ...
      <div className="worked-for-container">
        ...
        <div className="projects-grid">
          ...
          <div className="project-card">
            ...
            <div className="project-details">
              <h3 className="project-name">Figma Design</h3>
              <a 
                href="https://www.figma.com/design/cfMVqxGV49YRcfXeJbvju9/ikembannabueze-s-team-library?node-id=3311-2&t=UmfSvrlw7XaaB7b4-1" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="project-link-icon"
          ...
          <div className="project-card">
            ...
            <div className="project-details">
              <h3 className="project-name">Linkdin clone</h3>
              <a 
    ...
    <footer>
      <main>
        <div>
          <h2>Explore My Engineeing & Design Portfolio</h2>
          <p>Dive into a collection of projects. form deep-learning models to intuitive user platform, developed for enovation leade</p>
        </div>
        <div></div>
        <div></div>
      </main>
